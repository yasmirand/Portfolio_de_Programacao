...
#include <iomanip>//biblioteca pra usar setprecision, foi usado para imprimir um float com duas casas após a virgula
//bibliotecas para sortear  
#include <cstdlib>
#include <ctime>
#include <unistd.h>//biblioteca para importar o temporizador
using namespace std;
...
void entrar(char a){//função para receber o nome e a senha do usuário
    ...
    cout << "Digite seu nome: ";//mostra uma mensagem pedindo para o usuário escrever o nome
    cin >> nome;//armazena o nome do usuário
    cout << "Insira sua senha de quatro dígitos: ";//mostra uma mensagem pedindo para o usuário inserir a senha
    cin >> senha;//armazena a senha do usuário
    cout << "\n";//para pular uma linha
    //coloca uma linha de 50 caracteres
    for (int i = 0; i < 50; i++){
        cout << a;
    ...
    cout << "\n";//para pular uma linha
    cout << "* Bem-vindo(a) "<<nome <<" *";//mostra uma mensagem com o nome fornecido pelo usuário
    }

void atualizar_saldo(float *saldo){//função para atualizar o saldo inicial do usuário
...
void mostrar_extrato(char a, float *Extrato, float saldo, int ocorrencia){//função para mostrar o saldo atual e o extrato do usuário
    ...
    cout << "\n";//para pular uma linha
    cout << "Seu Saldo: "<<fixed << setprecision(2) << saldo<< "\n";//mostra ao usuário o saldo atual dele
    //coloca uma linha de 20 caracteres
    for (int i = 0; i < 20; i++){
            cout << a;
        }
    ...
    for (int i=0;i<=ocorrencia;i++){//pra imprimir o extrato
        cout << fixed << setprecision(2) <<Extrato[i]<< "\n";//impeime o elemento do extrato
        //coloca uma linha de 20 caracteres
        for (int i = 0; i < 20; i++){
            cout << a;
        }
...
void deposite(char a, float *Extrato, float *saldo, int *ocorrencia){//função para o usuário fazer um depósito
    //coloca uma linha de 50 caracteres
    for (int i = 0; i < 50; i++){
        cout << a;
    }
    ...
    cout << "Digite o valor que deseja depositar: ";//mostra uma mensagem pedindo para o usuário escrever o valor que deseja depositar
    cin >> deposito;//armazena o valor do depósito
...
void sacar(char a, float *Extrato, float *saldo, int *ocorrencia){ // função para o usuário fazer um saque
    ...
    cout << "\n";//para pular uma linha
    cout << "Digite o valor do saque: ";//pede ao usuário que digite o valor do saque
    cin >> saque;//armazena o valor do saque
    //coloca uma linha de 50 caracteres
    for (int i = 0; i < 50; i++){
        cout << a;
    }
    ...
    //coloca uma linha de 50 caracteres
        ...
        cout << "\n";//para pular uma linha
        cout << "Seu Saque foi autorizado!\n";//avisa ao usuário que o saque foi autorizado
        cout << "Seu Saldo: "<<fixed << setprecision(2) << *saldo<<"\n";//mostra ao usuário seu saldo atual
    //coloca uma linha de 50 caracteres
        for (int i = 0; i < 50; i++){
        cout << a;
    }
...
int main() {
    ...
    while (n != 4){//o codigo continuara rodando enquanto a escolha do usuário for diferente de 4
        ...
        cin >> n;//recebe e garda o valor de n
        ...
        cout << "\n";//para pular uma linha
        cout << "--> ";//mostra uma seta pra receber a opção escolhida pelo usuário
