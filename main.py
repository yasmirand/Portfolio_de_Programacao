...
def inicio():#uma função para iniciar o código
    nome = entrar(a) #armazena o nome do usuário
    ...
    while n != 4: #o código vai continuar sendo executado enquanto o usuário não digitar 4
        opcoes(a)# mostra o quadro de opções
        print(f"{a*50}") #coloca uma linha de 50 caracteres
        n = int(input("--> ")) #recebe a opção que o usuário escolheu
        if n == 1: #se o usuário escolher a opção 1
            mostrar_extrato(a, Extrato, saldo) #o saldo atual e o extrato será mostrado ao usuário
        elif n == 2: #se o usuário escolher a opção 2
            Extrato, saldo = deposite(a, Extrato, saldo) #o usuário irá depositar algum valor em sua conta
        elif n == 3: #se o usuário escolher a opção 3
            Extrato, saldo = sacar(a, Extrato, saldo) #o usuário poderá sacar algum valor de sua conta
    print(f"{a*50}") #coloca uma linha de 50 caracteres

def entrar(a):#função para receber o nome e a senha do usuário
    print(f"{a*50}")#coloca uma linha de 50 caracteres
...
def opcoes(a): #função para mostrar ao usuário as opções que ele tem
    print(f"{a*50}")#coloca uma linha de 50 caracteres
...
def mostrar_extrato(a, Extrato, saldo): #função para mostrar o saldo atual e o extrato do usuário
    print(f"{a*20}")#coloca uma linha de 20 caracteres
...
def deposite(a, Extrato, saldo):# função para o usuário fazer um depósito
    print(f"{a*50}")#coloca uma linha de 50 caracteres
...
def sacar(a, Extrato,saldo): # função para o usuário fazer um saque
    print(f"{a*50}")#coloca uma linha de 50 caracteres
